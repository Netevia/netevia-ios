...
Then add `NeteviaSDK` as a dependency in your target.
...
1. Go to the [Releases](https://github.com/Netevia/netevia-ios/releases) page
2. Download `NeteviaSDK.xcframework.zip`
3. Unzip and drag `NeteviaSDK.xcframework` into your Xcode project
...
Full SDK documentation can be found here: [NeteviaSDK Documentation](https://github.com/Netevia/netevia-ios/documentation/neteviasku/index.html).
...
## NeteviaMerchantSDK Usage Guide
...
## 🧭 Migration Guide: `NeteviaMerchantSDKError` → `NeteviaSDKError`
